...
namespace MCMNavigator
{
	...
	// Async. Safe to call from any thread. Schedules CacheModListFromPapyrus once per session;
	// retries only if the task interface was unavailable at the time of the call.
