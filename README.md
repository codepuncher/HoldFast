...
; Close the journal automatically when leaving MCM via Start. Only applies when sButtonStartAction=MCM.
...
; Close the journal automatically when leaving MCM via Back. Only applies when sButtonBackAction=MCM.
